...
import com.gonzapico.murmett.BaseMMApplication;
import com.gonzapico.murmett.UIThread;
...
@Module public class ApplicationModule {
  private final BaseMMApplication application;

  public ApplicationModule(BaseMMApplication application) {
  ...
  @Provides @Singleton UsersDomainRepository provideUserRepository(UsersRepository userRepository){
